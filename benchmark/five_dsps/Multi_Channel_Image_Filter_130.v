...
module complex_image_filter_design131 (
    ...
    wire signed [27:0] channel2_out;
    
    wire signed [33:0] channel3_out;
    
    wire signed [17:0] channel4_out;
    
    wire signed [23:0] channel5_out;
    ...
    // Source: xilinx_submuland_signed_18_bit_1_stage_variant_4.sv 
  ...
  assign channel1_out = stage0_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_8.sv 
    // Output width: 28 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [27:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_1_stage_variant_4.sv 
    // Output width: 34 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch3
    logic signed [33:0]stage0_ch3;
  ...
  assign channel3_out = stage0_ch3;
    ...
    // Source: xilinx_addmuland_signed_18_bit_2_stage_variant_3.sv 
    // Output width: 18 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [17:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [23:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {16{channel1_out[17]}}, channel1_out } +
        
        { {6{channel2_out[27]}}, channel2_out } +
        
        channel3_out +
        
        { {16{channel4_out[17]}}, channel4_out } +
        
        { {10{channel5_out[23]}}, channel5_out }
        ;
