...
// ===================================================================
module complex_image_filter_design327 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {10{channel1_out[21]}}, channel1_out } +
        
        { {4{channel2_out[27]}}, channel2_out } +
        
        { {14{channel3_out[17]}}, channel3_out } +
        
        channel4_out +
        
        { {9{channel5_out[22]}}, channel5_out }
        ;
