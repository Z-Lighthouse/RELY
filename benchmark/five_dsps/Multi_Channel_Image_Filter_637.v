...
// ===================================================================
module complex_image_filter_design663 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_1.sv 
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [32:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [18:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_3.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {11{channel1_out[21]}}, channel1_out } +
        
        { {10{channel2_out[22]}}, channel2_out } +
        
        channel3_out +
        
        { {14{channel4_out[18]}}, channel4_out } +
