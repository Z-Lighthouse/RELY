...
module High_Performance_PID_Controller (
    ...
    PreAdd_Mul_Acc_Unit_V1 P_Term_Unit (
        .clk(clk),
    ...
    PreAdd_Mul_Acc_Unit_V1 I_Term_Unit (
        .clk(clk),
    ...
    PreAdd_Mul_Acc_Unit_V1 D_Term_Unit (
        .clk(clk),
    ...
    PreAdd_Mul_Acc_Unit_V1 Adder_P_I (
        .clk(clk),
        .d(11'sd0),             // d: 0
    ...
    // Logic: out = ((d + a) * b) + c
    // Mapping: ((0 + 1) * D) + (P+I)
    PreAdd_Mul_Acc_Unit_V1 Adder_PID (
        .clk(clk),
        .d(11'sd0),             // d: 0
        .a(10'sd1),             // a: 1 (Multiplier factor)
