...
// ===================================================================
module complex_image_filter_design356 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [32:0] channel1_out;
    
    wire signed [34:0] channel2_out;
  ...
  assign channel1_out = stage0_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_4.sv 
    // Output width: 35 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [34:0]stage0_ch2, stage1_ch2;
  ...
  assign channel5_out = stage0_ch5;
    ...
    assign final_out = 
        ...
        { {2{channel1_out[32]}}, channel1_out } +
        
        channel2_out +
        
        { {10{channel3_out[24]}}, channel3_out } +
        
        { {17{channel4_out[17]}}, channel4_out } +
        
        { {1{channel5_out[33]}}, channel5_out }
        ;
