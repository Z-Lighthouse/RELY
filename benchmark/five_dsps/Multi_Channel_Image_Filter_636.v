...
// ===================================================================
module complex_image_filter_design657 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [25:0]stage0_ch2, stage1_ch2;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {8{channel2_out[25]}}, channel2_out } +
        
        { {9{channel3_out[24]}}, channel3_out } +
