...
// ===================================================================
module complex_image_filter_design642 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [35:0]stage0_ch2, stage1_ch2;
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [31:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_9.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel4_out[31]}}, channel4_out } +
        
        { {12{channel5_out[23]}}, channel5_out }
        ;
