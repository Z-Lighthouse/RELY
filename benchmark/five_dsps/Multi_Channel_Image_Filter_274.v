...
// ===================================================================
module complex_image_filter_design275 (
    // ------------------- Port Definitions -------------------
    input clk,
    input signed [9:0] pix1,
    ...
    input signed [13:0] pix5,
    input signed [11:0] k5a,
    input signed [17:0] k5b,
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_3.sv 
    // Output width: 22 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch1
    logic signed [21:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_18_bit_xilinx_2_stage_variant_3.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    assign final_out = 
        ...
        { {12{channel1_out[21]}}, channel1_out } +
