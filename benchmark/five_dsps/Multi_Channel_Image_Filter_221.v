...
// ===================================================================
module complex_image_filter_design222 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_18_bit_xilinx_2_stage_variant_5.sv 
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_submuland_signed_18_bit_2_stage_variant_6.sv 
  ...
  assign channel3_out = stage1_ch3;
    ...
    assign final_out = 
        ...
        { {9{channel2_out[24]}}, channel2_out } +
