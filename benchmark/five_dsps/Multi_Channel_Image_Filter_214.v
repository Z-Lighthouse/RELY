...
// ===================================================================
module complex_image_filter_design215 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_1.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_3.sv 
    ...
    assign final_out = 
        ...
        { {13{channel1_out[21]}}, channel1_out } +
        
        channel2_out +
        
        { {17{channel3_out[17]}}, channel3_out } +
        
        { {17{channel4_out[17]}}, channel4_out } +
        
        { {3{channel5_out[31]}}, channel5_out }
        ;
