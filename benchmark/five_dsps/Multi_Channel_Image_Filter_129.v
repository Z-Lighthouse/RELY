...
// ===================================================================
module complex_image_filter_design130 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel3_out = stage1_ch3;
    ...
    assign final_out = 
        ...
        { {14{channel1_out[22]}}, channel1_out } +
        
        { {19{channel2_out[17]}}, channel2_out } +
        
        { {15{channel3_out[21]}}, channel3_out } +
        
        { {6{channel4_out[30]}}, channel4_out } +
