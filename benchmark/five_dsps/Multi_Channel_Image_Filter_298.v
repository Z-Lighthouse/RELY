...
// ===================================================================
module complex_image_filter_design299 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {5{channel1_out[24]}}, channel1_out } +
        
        { {12{channel2_out[17]}}, channel2_out } +
        
        { {12{channel3_out[17]}}, channel3_out } +
        
        channel4_out +
        
        { {1{channel5_out[28]}}, channel5_out }
        ;
