...
// ===================================================================
module complex_image_filter_design010 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {6{channel1_out[28]}}, channel1_out } +
        
        channel2_out +
        
        { {1{channel3_out[33]}}, channel3_out } +
        
        { {7{channel4_out[27]}}, channel4_out } +
        
        { {10{channel5_out[24]}}, channel5_out }
        ;
