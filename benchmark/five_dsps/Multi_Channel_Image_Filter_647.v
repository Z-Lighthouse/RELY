...
// ===================================================================
module complex_image_filter_design693 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [28:0] channel3_out;
    
    wire signed [21:0] channel4_out;
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [28:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [21:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [31:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {5{channel3_out[28]}}, channel3_out } +
        
        { {12{channel4_out[21]}}, channel4_out } +
