...
module complex_image_filter_design427 (
    ...
    wire signed [32:0] channel2_out;
    
    wire signed [27:0] channel3_out;
    
    wire signed [23:0] channel4_out;
    
    wire signed [24:0] channel5_out;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_3.sv 
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_1_stage_variant_3.sv 
    // Output width: 33 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [32:0]stage0_ch2;
  ...
  assign channel2_out = stage0_ch2;
    ...
    // Source: xilinx_addmulsub_signed_18_bit_1_stage_variant_7.sv 
    // Output width: 28 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch3
    logic signed [27:0]stage0_ch3;
  ...
  assign channel3_out = stage0_ch3;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_6.sv 
    // Output width: 24 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [23:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [24:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {8{channel1_out[24]}}, channel1_out } +
        
        channel2_out +
        
        { {5{channel3_out[27]}}, channel3_out } +
        
        { {9{channel4_out[23]}}, channel4_out } +
        
        { {8{channel5_out[24]}}, channel5_out }
        ;
