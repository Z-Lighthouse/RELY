...
// ===================================================================
module complex_image_filter_design692 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [29:0] channel4_out;
    
    wire signed [35:0] channel5_out;
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [31:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: xilinx_muladd_signed_8_bit_2_stage_variant_0.sv 
    // Output width: 30 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [29:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_6.sv 
    // Output width: 36 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch5
    logic signed [35:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {8{channel1_out[27]}}, channel1_out } +
        
        { {16{channel2_out[19]}}, channel2_out } +
        
        { {4{channel3_out[31]}}, channel3_out } +
        
        { {6{channel4_out[29]}}, channel4_out } +
