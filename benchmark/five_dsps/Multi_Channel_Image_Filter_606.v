...
// ===================================================================
module complex_image_filter_design616 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [35:0] channel3_out;
    
    wire signed [19:0] channel4_out;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_2.sv 
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [35:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [19:0]stage0_ch4, stage1_ch4;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {11{channel2_out[24]}}, channel2_out } +
        
        channel3_out +
        
        { {16{channel4_out[19]}}, channel4_out } +
