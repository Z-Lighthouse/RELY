...
// ===================================================================
module complex_image_filter_design256 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {10{channel1_out[22]}}, channel1_out } +
        
        { {5{channel2_out[27]}}, channel2_out } +
        
        { {15{channel3_out[17]}}, channel3_out } +
        
        channel4_out +
        
        { {15{channel5_out[17]}}, channel5_out }
        ;
