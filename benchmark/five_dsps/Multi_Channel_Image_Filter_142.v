...
// ===================================================================
module complex_image_filter_design143 (
    // ------------------- Port Definitions -------------------
    input clk,
    input signed [16:0] pix1,
    input signed [11:0] k1a,
    input signed [15:0] k1b,
    ...
    logic signed [34:0]stage0_ch1, stage1_ch1;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_4.sv 
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_4.sv 
    // Output width: 31 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [30:0]stage0_ch4;
    ...
    assign final_out = 
        ...
        { {12{channel2_out[22]}}, channel2_out } +
        
        { {6{channel3_out[28]}}, channel3_out } +
        
        { {4{channel4_out[30]}}, channel4_out } +
