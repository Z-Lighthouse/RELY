...
// ===================================================================
module complex_image_filter_design155 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_1.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel2_out[26]}}, channel2_out } +
        
        { {13{channel3_out[17]}}, channel3_out } +
        
        { {7{channel4_out[23]}}, channel4_out } +
