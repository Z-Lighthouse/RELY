...
module complex_image_filter_design634 (
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_4.sv 
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_9.sv 
    // Output width: 33 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [32:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [29:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_3.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_2.sv 
    // Output width: 27 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch5
    logic signed [26:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {3{channel3_out[29]}}, channel3_out } +
        
        { {5{channel4_out[27]}}, channel4_out } +
        
        { {6{channel5_out[26]}}, channel5_out }
        ;
