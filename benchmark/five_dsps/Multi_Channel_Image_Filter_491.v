...
// ===================================================================
module complex_image_filter_design492 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    logic signed [22:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_addmuland_signed_18_bit_1_stage_variant_4.sv 
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_9.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_submuland_signed_18_bit_2_stage_variant_8.sv 
    // Output width: 18 bits
    // Signed processing
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {11{channel1_out[22]}}, channel1_out } +
        ...
        { {16{channel5_out[17]}}, channel5_out }
        ;
