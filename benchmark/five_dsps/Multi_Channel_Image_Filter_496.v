...
// ===================================================================
module complex_image_filter_design497 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_7.sv 
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_7.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_0.sv 
    ...
    assign final_out = 
        ...
        { {9{channel1_out[24]}}, channel1_out } +
        
        { {6{channel2_out[27]}}, channel2_out } +
        
        channel3_out +
        
        { {10{channel4_out[23]}}, channel4_out } +
        
        { {2{channel5_out[31]}}, channel5_out }
        ;
