...
// ===================================================================
module complex_image_filter_design695 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [19:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {14{channel3_out[19]}}, channel3_out } +
        
        channel4_out +
        
        { {4{channel5_out[29]}}, channel5_out }
        ;
