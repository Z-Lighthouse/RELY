...
// ===================================================================
module complex_image_filter_design617 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [20:0]stage0_ch4, stage1_ch4;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {6{channel2_out[25]}}, channel2_out } +
        
        { {5{channel3_out[26]}}, channel3_out } +
        
        { {11{channel4_out[20]}}, channel4_out } +
        
        { {8{channel5_out[23]}}, channel5_out }
        ;
