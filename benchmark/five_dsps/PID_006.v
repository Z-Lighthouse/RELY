...
//   - Instantiation mappings optimized: 'b' port (18-bit) is used for the primary signal path.
//
module High_Performance_PID_Controller (
    ...
    PreAdd_Mul_Acc_Unit I_Term_Unit (
        ...
        .c(integral_term_reg[30:19]), // c: I_old (31-bit -> 12-bit MSB truncated)
        .out(i_term)
    );
    ...
    PreAdd_Mul_Acc_Unit Adder_P_I (
        .clk(clk),
        .d(11'sd0),             // d: 0
        .a(10'sd1),             // a: 1 (Multiplier factor, results in (0+1)*b)
