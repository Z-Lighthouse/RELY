...
// ===================================================================
module complex_image_filter_design602 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [19:0] channel2_out;
    
    wire signed [21:0] channel3_out;
    
    wire signed [33:0] channel4_out;
    
    wire signed [20:0] channel5_out;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_6.sv 
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_muladd_signed_8_bit_2_stage_variant_1.sv 
    // Output width: 20 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [19:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_4.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [20:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {3{channel1_out[30]}}, channel1_out } +
        
        { {14{channel2_out[19]}}, channel2_out } +
        
        { {12{channel3_out[21]}}, channel3_out } +
        
        channel4_out +
        
        { {13{channel5_out[20]}}, channel5_out }
        ;
