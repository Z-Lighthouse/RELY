...
// ===================================================================
module complex_image_filter_design609 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    logic signed [35:0]stage0_ch1, stage1_ch1;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {6{channel2_out[29]}}, channel2_out } +
        
        { {13{channel3_out[22]}}, channel3_out } +
        
        { {18{channel4_out[17]}}, channel4_out } +
        
        { {4{channel5_out[31]}}, channel5_out }
        ;
