...
module complex_image_filter_design273 (
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_7.sv 
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_1_stage_variant_9.sv 
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_2.sv 
    // Output width: 31 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch5
    logic signed [30:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {5{channel1_out[28]}}, channel1_out } +
        
        { {3{channel2_out[30]}}, channel2_out } +
        
        { {12{channel3_out[21]}}, channel3_out } +
        
        channel4_out +
        
        { {3{channel5_out[30]}}, channel5_out }
        ;
