...
//           Final output width: 28 bits (max of all channels)
// ===================================================================
module complex_image_filter_design361 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    input signed [11:0] k2c,
    input signed [8:0] pix3,
    input signed [9:0] k3a,
    input signed [12:0] k3b,
    input signed [14:0] k3c,
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [24:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {6{channel1_out[21]}}, channel1_out } +
        
        { {10{channel2_out[17]}}, channel2_out } +
        
        { {3{channel3_out[24]}}, channel3_out } +
        
        channel4_out +
        
        { {10{channel5_out[17]}}, channel5_out }
        ;
