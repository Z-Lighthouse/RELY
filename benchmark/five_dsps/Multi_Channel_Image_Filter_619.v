...
// ===================================================================
module complex_image_filter_design637 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [18:0]stage0_ch2, stage1_ch2;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {17{channel2_out[18]}}, channel2_out } +
        
        { {4{channel3_out[31]}}, channel3_out } +
        
        { {14{channel4_out[21]}}, channel4_out } +
        
        { {9{channel5_out[26]}}, channel5_out }
        ;
