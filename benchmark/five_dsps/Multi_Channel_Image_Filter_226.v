...
// ===================================================================
module complex_image_filter_design227 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [28:0]stage0_ch4, stage1_ch4;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {17{channel1_out[17]}}, channel1_out } +
        
        channel2_out +
        
        { {4{channel3_out[30]}}, channel3_out } +
        
        { {6{channel4_out[28]}}, channel4_out } +
        
        { {4{channel5_out[30]}}, channel5_out }
        ;
