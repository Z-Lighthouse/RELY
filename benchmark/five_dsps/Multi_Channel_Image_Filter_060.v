...
// ===================================================================
module complex_image_filter_design061 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [23:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel3_out[23]}}, channel3_out } +
        
        { {10{channel4_out[17]}}, channel4_out } +
