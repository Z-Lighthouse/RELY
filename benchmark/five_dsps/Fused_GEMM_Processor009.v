...
module Compute_Intensive_System (
    ...
    input signed [15:0] D_in_0,       // Matrix D inputs for the systolic array (Col 0)
    input signed [15:0] D_in_1,       // Matrix D inputs for the systolic array (Col 1)
    input signed [17:0] A_in_0,       // Matrix A inputs for the systolic array (Row 0)
    input signed [17:0] A_in_1,       // Matrix A inputs for the systolic array (Row 1)
    input signed [9:0]  B_in_0,       // Matrix B inputs for the systolic array (Col 0)
    input signed [9:0]  B_in_1,       // Matrix B inputs for the systolic array (Col 1)
    input signed [9:0]  scaling_factor, // Scalar input for the post-processing stage
    ...
    PreAdd_Mul_Unit post_processor_inst (
        ...
        .d(c_00[15:0]),   // d <= C[0][0] (truncated)
        .a(c_11[17:0]),   // a <= C[1][1] (truncated)
...
module Systolic_Array_Processor (
    input clk,
    input rst_n,
    input signed [15:0] D_in_0,
    input signed [15:0] D_in_1,
    input signed [17:0] A_in_0,
    input signed [17:0] A_in_1,
    input signed [9:0]  B_in_0,
    input signed [9:0]  B_in_1,
    ...
    wire signed [15:0] d_v_wire_0_to_0, d_v_wire_1_to_1; // Vertical path for D
    wire signed [17:0] a_h_wire_0_to_1, a_h_wire_1_to_1; // Horizontal path for A
    wire signed [9:0]  b_v_wire_0_to_0, b_v_wire_1_to_1; // Vertical path for B
...
module ProcessingElement (
    ...
    input signed [15:0] d_in,   // Input 'D' from top neighbor
    input signed [17:0] a_in,   // Input 'A' from left neighbor
    input signed [9:0]  b_in,   // Input 'B' from top neighbor
    
    output reg signed [15:0] d_out, // Output 'D' to bottom neighbor
    output reg signed [17:0] a_out, // Output 'A' to right neighbor
    output reg signed [9:0]  b_out, // Output 'B' to bottom neighbor
    output signed [28:0] c_out    // Result of the operation
);
