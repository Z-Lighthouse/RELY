...
// ===================================================================
module complex_image_filter_design714 (
    input clk,
    ...
    wire signed [46:0] channel4_out;  // 47-bit adder
    ...
    assign final_out =
        ...
        { {13{channel2_out[33]}}, channel2_out } +    // 34 → 47
        { {18{channel3_out[29]}}, channel3_out } +    // 30 → 47
        channel4_out +                                // 47
        { {14{channel5_out[32]}}, channel5_out };     // 33 → 47
