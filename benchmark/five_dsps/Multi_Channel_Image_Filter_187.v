...
// ===================================================================
module complex_image_filter_design188 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    wire signed [26:0] channel1_out;
    
    wire signed [24:0] channel2_out;
    ...
    logic signed [26:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [24:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_submuland_signed_18_bit_2_stage_variant_4.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    assign final_out = 
        ...
        { {2{channel2_out[24]}}, channel2_out } +
        
        { {9{channel3_out[17]}}, channel3_out } +
        
        { {5{channel4_out[21]}}, channel4_out } +
        
        { {9{channel5_out[17]}}, channel5_out }
        ;
