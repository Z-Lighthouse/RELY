...
//           Final output width: 27 bits (max of all channels)
// ===================================================================
module complex_image_filter_design114 (
    // ------------------- Port Definitions -------------------
    input clk,
    input signed [14:0] pix1,
    input signed [11:0] k1a,
    input signed [7:0] k1b,
    input signed [8:0] k1c,
    input signed [7:0] pix2,
    input signed [10:0] k2a,
    input signed [8:0] k2b,
    input signed [13:0] k2c,
    input signed [10:0] pix3,
    input signed [11:0] k3a,
    input signed [8:0] k3b,
    input signed [12:0] k3c,
    input signed [8:0] pix4,
    input signed [14:0] k4a,
    input signed [9:0] k4b,
    input signed [7:0] k4c,
    input signed [7:0] pix5,
    input signed [8:0] k5a,
    input signed [11:0] k5b,
    input signed [17:0] k5c,
    output signed [26:0] final_out
);

    // ------------------- Internal Signals -------------------
    // Channel outputs
    
    wire signed [24:0] channel1_out;
    
    wire signed [21:0] channel2_out;
    
    wire signed [17:0] channel3_out;
    
    wire signed [26:0] channel4_out;
    
    wire signed [22:0] channel5_out;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_6.sv 
    // Output width: 25 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch1
    logic signed [24:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_18_bit_xilinx_2_stage_variant_8.sv 
    // Output width: 22 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [21:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_addmuland_signed_18_bit_2_stage_variant_0.sv 
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_5.sv 
    // Output width: 27 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [26:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_18_bit_xilinx_2_stage_variant_7.sv 
    // Output width: 23 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch5
    logic signed [22:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {2{channel1_out[24]}}, channel1_out } +
        
        { {5{channel2_out[21]}}, channel2_out } +
        
        { {9{channel3_out[17]}}, channel3_out } +
        
        channel4_out +
        
        { {4{channel5_out[22]}}, channel5_out }
        ;
