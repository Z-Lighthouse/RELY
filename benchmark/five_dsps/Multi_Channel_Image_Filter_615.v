...
// ===================================================================
module complex_image_filter_design630 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [32:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [18:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {1{channel1_out[31]}}, channel1_out } +
        
        { {3{channel2_out[29]}}, channel2_out } +
        
        { {10{channel3_out[22]}}, channel3_out } +
        
        channel4_out +
        
        { {14{channel5_out[18]}}, channel5_out }
        ;
