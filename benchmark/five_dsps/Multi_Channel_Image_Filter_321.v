...
// ===================================================================
module complex_image_filter_design322 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage0_ch1;
    ...
    logic signed [34:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {3{channel2_out[31]}}, channel2_out } +
        
        channel3_out +
        
        { {1{channel4_out[33]}}, channel4_out } +
        
        { {11{channel5_out[23]}}, channel5_out }
        ;
