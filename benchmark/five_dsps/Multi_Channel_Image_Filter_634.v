...
// ===================================================================
module complex_image_filter_design655 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_1.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {11{channel1_out[24]}}, channel1_out } +
        
        { {7{channel2_out[28]}}, channel2_out } +
        
        channel3_out +
        
        { {5{channel4_out[30]}}, channel4_out } +
