...
// ===================================================================
module complex_image_filter_design106 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {8{channel1_out[22]}}, channel1_out } +
        
        channel2_out +
        
        { {9{channel3_out[21]}}, channel3_out } +
        
        { {13{channel4_out[17]}}, channel4_out } +
        
        { {4{channel5_out[26]}}, channel5_out }
        ;
