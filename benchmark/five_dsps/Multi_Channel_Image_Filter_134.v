...
// ===================================================================
module complex_image_filter_design135 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_1_stage_variant_7.sv 
  ...
  assign channel5_out = stage0_ch5;
    ...
    assign final_out = 
        ...
        { {11{channel3_out[21]}}, channel3_out } +
        
        { {2{channel4_out[30]}}, channel4_out } +
