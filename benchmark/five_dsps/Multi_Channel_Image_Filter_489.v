...
// ===================================================================
module complex_image_filter_design490 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    logic signed [23:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_addmuland_signed_18_bit_2_stage_variant_8.sv 
  ...
  assign channel4_out = stage1_ch4;
    ...
    assign final_out = 
        ...
        { {6{channel1_out[27]}}, channel1_out } +
        
        { {10{channel2_out[23]}}, channel2_out } +
