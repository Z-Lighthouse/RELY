...
//           Final output width: 25 bits (max of all channels)
// ===================================================================
module complex_image_filter_design335 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel3_out = stage1_ch3;
    ...
    assign final_out = 
        ...
        { {7{channel1_out[17]}}, channel1_out } +
        
        { {7{channel2_out[17]}}, channel2_out } +
        
        channel3_out +
        
        { {7{channel4_out[17]}}, channel4_out } +
        
        { {7{channel5_out[17]}}, channel5_out }
        ;
