...
// ===================================================================
module complex_image_filter_design172 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    // Source: one_stage_add_mul_add_signed_11_bit_xilinx_2_stage_variant_2.sv 
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_submuland_signed_18_bit_1_stage_variant_0.sv 
  ...
  assign channel3_out = stage0_ch3;
    ...
    // Source: xilinx_submuland_signed_18_bit_1_stage_variant_8.sv 
    // Output width: 18 bits
    // Signed processing
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel1_out[28]}}, channel1_out } +
        
        { {15{channel2_out[17]}}, channel2_out } +
        
        channel3_out +
        
        { {15{channel4_out[17]}}, channel4_out } +
