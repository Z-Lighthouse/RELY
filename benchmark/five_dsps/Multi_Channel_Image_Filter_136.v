...
// ===================================================================
module complex_image_filter_design137 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_2_stage_variant_5.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {6{channel1_out[24]}}, channel1_out } +
        
        { {9{channel2_out[21]}}, channel2_out } +
        
        { {13{channel3_out[17]}}, channel3_out } +
        
        { {6{channel4_out[24]}}, channel4_out } +
