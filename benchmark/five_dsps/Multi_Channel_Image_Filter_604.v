...
module complex_image_filter_design612 (
    ...
    wire signed [29:0] channel2_out;
    
    wire signed [20:0] channel3_out;
    ...
    // Source: xilinx_muladd_signed_8_bit_2_stage_variant_2.sv 
    // Output width: 34 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch1
    logic signed [33:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_2.sv 
    // Output width: 30 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [29:0]stage0_ch2, stage1_ch2;
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [20:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel2_out[29]}}, channel2_out } +
        
        { {13{channel3_out[20]}}, channel3_out } +
        
        { {3{channel4_out[30]}}, channel4_out } +
