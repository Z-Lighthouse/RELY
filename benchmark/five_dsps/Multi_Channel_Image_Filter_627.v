...
//           Final output width: 36 bits (max of all channels)
// ===================================================================
module complex_image_filter_design647 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    output signed [35:0] final_out
);

    // ------------------- Internal Signals -------------------
    // Channel outputs
    
    wire signed [19:0] channel1_out;
    
    wire signed [31:0] channel2_out;
    
    wire signed [33:0] channel3_out;
    
    wire signed [35:0] channel4_out;
    
    wire signed [25:0] channel5_out;
    ...
    logic signed [19:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_muladd_signed_8_bit_2_stage_variant_4.sv 
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [33:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: xilinx_muladd_signed_18_bit_2_stage_variant_8.sv 
    // Output width: 36 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [35:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    logic signed [25:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {16{channel1_out[19]}}, channel1_out } +
        
        { {4{channel2_out[31]}}, channel2_out } +
        
        { {2{channel3_out[33]}}, channel3_out } +
        
        channel4_out +
        
        { {10{channel5_out[25]}}, channel5_out }
        ;
