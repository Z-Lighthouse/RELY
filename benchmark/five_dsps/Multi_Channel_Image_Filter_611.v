...
//           Final output width: 34 bits (max of all channels)
// ===================================================================
module complex_image_filter_design621 (
    // ------------------- Port Definitions -------------------
    input clk,
    input signed [11:0] pix1,
    input signed [7:0] k1b,
    input signed [10:0] k1c,
    input signed [16:0] pix2,
    input signed [13:0] k2b,
    input signed [12:0] k2c,
    input signed [12:0] pix3,
    input signed [7:0] k3b,
    input signed [13:0] k3c,
    input signed [17:0] pix4,
    input signed [14:0] k4b,
    input signed [13:0] k4c,
    input signed [11:0] pix5,
    input signed [15:0] k5b,
    input signed [13:0] k5c,
    output signed [33:0] final_out
);

    // ------------------- Internal Signals -------------------
    // Channel outputs
    
    wire signed [20:0] channel1_out;
    
    wire signed [31:0] channel2_out;
    
    wire signed [21:0] channel3_out;
    
    wire signed [33:0] channel4_out;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_7.sv 
    // Output width: 21 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch1
    logic signed [20:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_muladd_signed_8_bit_2_stage_variant_6.sv 
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_6.sv 
    // Output width: 22 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch3
    logic signed [21:0]stage0_ch3, stage1_ch3;
  ...
  assign channel3_out = stage1_ch3;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_9.sv 
    // Output width: 34 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch4
    logic signed [33:0]stage0_ch4, stage1_ch4;
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: xilinx_muladd_signed_8_bit_yosys_plugin_2_stage_variant_0.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {13{channel1_out[20]}}, channel1_out } +
        
        { {2{channel2_out[31]}}, channel2_out } +
        
        { {12{channel3_out[21]}}, channel3_out } +
        
        channel4_out +
        
        { {5{channel5_out[28]}}, channel5_out }
        ;
