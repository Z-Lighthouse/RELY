...
//           Final output width: 30 bits (max of all channels)
// ===================================================================
module complex_image_filter_design146 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: one_stage_add_mul_add_signed_18_bit_xilinx_1_stage_variant_4.sv 
    // Output width: 30 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch2
    logic signed [29:0]stage0_ch2;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {12{channel1_out[17]}}, channel1_out } +
        
        channel2_out +
        
        { {5{channel3_out[24]}}, channel3_out } +
        
        { {12{channel4_out[17]}}, channel4_out } +
        
        { {12{channel5_out[17]}}, channel5_out }
        ;
