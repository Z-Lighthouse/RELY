...
// ===================================================================
module complex_image_filter_design191 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_submuland_signed_18_bit_1_stage_variant_6.sv 
  ...
  assign channel2_out = stage0_ch2;
    ...
    // Source: xilinx_addmuland_signed_18_bit_1_stage_variant_2.sv 
    // Output width: 18 bits
    // Signed processing
  ...
  assign channel4_out = stage1_ch4;
    ...
    // Source: one_stage_add_mul_add_signed_12_bit_xilinx_1_stage_variant_2.sv 
    // Output width: 34 bits
    // Signed processing
    // Stage signals renamed with suffix: _ch5
    logic signed [33:0]stage0_ch5;
    ...
    assign final_out = 
        ...
        { {16{channel2_out[17]}}, channel2_out } +
        
        { {16{channel3_out[17]}}, channel3_out } +
        
        { {7{channel4_out[26]}}, channel4_out } +
