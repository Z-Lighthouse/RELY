...
//           Final output width: 22 bits (max of all channels)
// ===================================================================
module complex_image_filter_design157 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel2_out[17]}}, channel2_out } +
        
        { {4{channel3_out[17]}}, channel3_out } +
        
        { {4{channel4_out[17]}}, channel4_out } +
        
        { {4{channel5_out[17]}}, channel5_out }
        ;
