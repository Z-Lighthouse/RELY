...
// ===================================================================
module complex_image_filter_design639 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    logic signed [25:0]stage0_ch3, stage1_ch3;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {10{channel1_out[19]}}, channel1_out } +
        
        channel2_out +
        
        { {4{channel3_out[25]}}, channel3_out } +
        
        { {8{channel4_out[21]}}, channel4_out } +
