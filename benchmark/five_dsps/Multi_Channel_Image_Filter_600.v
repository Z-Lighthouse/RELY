...
// ===================================================================
module complex_image_filter_design601 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel3_out = stage1_ch3;
    ...
    logic signed [25:0]stage0_ch4, stage1_ch4;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel1_out[31]}}, channel1_out } +
        
        channel2_out +
        
        { {6{channel3_out[29]}}, channel3_out } +
        
        { {10{channel4_out[25]}}, channel4_out } +
        
        { {6{channel5_out[29]}}, channel5_out }
        ;
