...
// ===================================================================
module complex_image_filter_design686 (
    // ------------------- Port Definitions -------------------
    input clk,
    ...
    logic signed [31:0]stage0_ch1, stage1_ch1;
  ...
  assign channel1_out = stage1_ch1;
    ...
    // Source: xilinx_mulsub_signed_18_bit_2_stage_variant_5.sv 
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {2{channel1_out[31]}}, channel1_out } +
        
        { {12{channel2_out[21]}}, channel2_out } +
        
        { {4{channel3_out[29]}}, channel3_out } +
        
        channel4_out +
        
        { {12{channel5_out[21]}}, channel5_out }
        ;
