...
// ===================================================================
module complex_image_filter_design418 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel4_out = stage0_ch4;
    ...
    logic signed [34:0]stage0_ch5, stage1_ch5;
  ...
  assign channel5_out = stage1_ch5;
    ...
    assign final_out = 
        ...
        { {4{channel1_out[30]}}, channel1_out } +
        
        { {10{channel2_out[24]}}, channel2_out } +
        
        { {13{channel3_out[21]}}, channel3_out } +
