...
// ===================================================================
module complex_image_filter_design092 (
    // ------------------- Port Definitions -------------------
    input clk,
  ...
  assign channel2_out = stage1_ch2;
    ...
    // Source: xilinx_submuland_signed_18_bit_2_stage_variant_9.sv 
  ...
  assign channel5_out = stage0_ch5;
    ...
    assign final_out = 
        ...
        { {15{channel1_out[21]}}, channel1_out } +
        
        { {9{channel2_out[27]}}, channel2_out } +
        
        channel3_out +
        
        { {19{channel4_out[17]}}, channel4_out } +
        
        { {19{channel5_out[17]}}, channel5_out }
        ;
