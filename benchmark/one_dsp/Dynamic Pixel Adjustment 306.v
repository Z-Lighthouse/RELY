...
module top_complex #(
    ...
    always @(posedge clk) begin
        ...
        if ($signed(a) < 0 && $signed({{3{b[13]}}, b[10:0]}) < $signed(a)) begin
            mode_sel   <= 3'b000;
            enable_adj <= 1'b1;
            alpha      <= d[8:0];
            offset     <= c;
        ...
        else if ($signed(a) == $signed({{3{b[13]}}, b[10:0]})) begin
            mode_sel   <= 3'b001;
            enable_adj <= 1'b1;
            alpha      <= d[8:0];
            offset     <= c;
        ...
        else if ($signed(a) > $signed({{3{b[13]}}, b[10:0]}) && c[7]) begin
            mode_sel   <= 3'b011;
            enable_adj <= 1'b1;
            alpha      <= d[8:0];
            offset     <= c;
