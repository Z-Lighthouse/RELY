...
module top_complex #(
    ...
    always @(posedge clk) begin
        ...
        if ($signed(a) < 0 && $signed({{2{b[13]}}, b[11:0]}) < $signed(a)) begin
            mode_sel   <= 3'b000;
            enable_adj <= 1'b1;
            alpha      <= d[10:0];
            offset     <= c;
        ...
        else if ($signed(a) == $signed({{2{b[13]}}, b[11:0]})) begin
            mode_sel   <= 3'b001;
            enable_adj <= 1'b1;
            alpha      <= d[10:0];
            offset     <= c;
        ...
        else if ($signed(a) > $signed({{2{b[13]}}, b[11:0]}) && c[8]) begin
            mode_sel   <= 3'b011;
            enable_adj <= 1'b1;
            alpha      <= d[10:0];
            offset     <= c;
