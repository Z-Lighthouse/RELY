...
module top_complex #(
    ...
    input signed [10:0] c,
    input clk,
    output signed [20:0] final_out
);

    // ------------------- Internal Signals -------------------
    reg signed [20:0] adjusted_value;
  ...
  assign out = stage1;
    ...
    always @(posedge clk) begin
        case (mode_sel)
            ...
            3'b011: temp <= {1'b0, {20{1'b1}}}; // Saturation (clamp to max positive value)
